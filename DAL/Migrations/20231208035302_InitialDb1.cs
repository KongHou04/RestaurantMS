        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TableID = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    TableOrdByArea = table.Column<int>(type: "integer", nullable: false),
                    Status = table.Column<bool>(type: "Boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Incedentals = table.Column<double>(type: "double precision", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GrandTotal = table.Column<double>(type: "double precision", nullable: false),
                    Recived = table.Column<double>(type: "double precision", nullable: true),
                    Return = table.Column<double>(type: "double precision", nullable: true),
